...
const importMap = {
  pinia: async () => {
    const pkg = await import('__mf__virtual/friends__prebuild__pinia__prebuild__.js')
    return pkg
  },
  vue: async () => {
    const pkg = await import('__mf__virtual/friends__prebuild__vue__prebuild__.js')
    return pkg
  },
}
const usedShared = {
